    ...
    <div className="flex gap-2">
      {status === "awaiting-answer" ? (
        ...
        questionDifficulties.map((difficulty) => {
          ...
          if (difficulty === "easy") {
            extraClass =
              "bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 dark:text-blue-400 border border-blue-500";
          } else if (difficulty === "medium") {
            extraClass =
              "bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-600 dark:text-yellow-400 border border-yellow-500";
          } else if (difficulty === "hard") {
            extraClass =
              "bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500";
          }
