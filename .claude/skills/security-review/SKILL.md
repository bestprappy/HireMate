...
description: "Review HireMate code for security risks across Next.js client and Golang Fiber services, including auth, endpoint exposure, secret handling, input validation, and event/API boundary protections."
---
...
7. Injection/Traversal Risks:
   - SQL query abuse, path traversal, insecure file upload handling.
8. Async/Event Risks:
